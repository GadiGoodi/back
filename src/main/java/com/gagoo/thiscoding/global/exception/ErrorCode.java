...
public enum ErrorCode {
    ...
    INVALID_FRIEND_REQUEST(HttpStatus.BAD_REQUEST, "유효하지 않은 요청입니다."),
    INVALID_LIKE_COUNT(HttpStatus.BAD_REQUEST, "현재 추천 수가 0이므로 더 이상 감소할 수 없습니다."),
    INVALID_ANSWER_USER(HttpStatus.CONFLICT, "본인 답변은 채택할 수 없습니다."),
    NOT_QNA_USER(HttpStatus.CONFLICT, "원본 게시글 작성자만 채택할 수 있습니다."),
    ...
    EXIST_ADOPTED_ANSWER(HttpStatus.CONFLICT, "이미 채택된 답변이 존재합니다."),
    ...
    LIKE_NOT_FOUND(HttpStatus.NOT_FOUND, "추천하지 않은 게시물입니다."),
    ...
    ACCESS_DENIED(HttpStatus.UNAUTHORIZED, "접근 가능한 권한이 부족합니다"),
